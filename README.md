...
* [Kubernetes Ingress Controller](https://github.com/Kong/kubernetes-ingress-controller) ⭐ 2,410 | 🐛 282 | 🌐 Go | 📅 2026-09-04 - Use Kong for Kubernetes Ingress
...
* [Heroku](https://github.com/heroku/heroku-kong) ⚠️ Archived - Deploy Kong Community Edition clusters to Heroku Common Runtime and Private Spaces using the Kong buildpack
* [Homebrew](https://github.com/Kong/homebrew-kong) ⚠️ Archived - Homebrew Formula for Kong
* [AWS Cloudformation](https://github.com/Kong/kong-dist-cloudformation) ⭐ 65 | 🐛 6 | 📅 2020-07-06 - This CloudFormation template helps you model and set up Kong's resources in AWS easily
...
* [decK](https://github.com/hbagdi/deck) ⭐ 504 | 🐛 101 | 🌐 Go | 📅 2026-09-04 - CLI tool to configure Kong declaratively using a single config file **(Compatiable with Kong 1.x)**
...
* [Kong OpenID Connect](https://github.com/nokia/kong-oidc) ⚠️ Archived - Plugin for Kong implementing the OpenID Connect Relying Party (RP) functionality
* [Kong External OAuth 2.0](https://github.com/mogui/kong-external-oauth) ⭐ 77 | 🐛 5 | 🌐 Lua | 📅 2018-01-09 - Use an external OAuth 2.0 provider to protect your API
